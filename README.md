...
| [Gram](https://github.com/speakeasy-api/gram)                                                             | 🟢 Open source | Gram is an open-source AI control plane for governing access to MCPs, Skills, and Assistants with policy enforcement, threat detection, and searchable event records.                                                               |
